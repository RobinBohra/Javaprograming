...
public class P3_Task01_WrappingClassesInJava {
	...
	public static void main(String[] args) {
		...
		int a = 10;
		String s =  "" + a + "" ;
		Integer i = Integer.valueOf(a);//converting int value Integer explicitly
		Integer j = a;//auto boxing : now compiler automatically write Integer.valueof(a)
		
		System.out.println(a + " " + i + " " + j );
		
		System.out.println(i.toString());
		//a.toString can not be used as a is an int type not an object
		//auto boxing converting primitive into objects
